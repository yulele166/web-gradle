...
if(!dc.body2.children("table.datagrid-btable-frozen").length){
    dc.body1.add(dc.body2).prepend("<table class=\"datagrid-btable  euig-btable datagrid-btable-frozen\" cellspacing=\"0\" cellpadding=\"0\"></table>");
}
_608(true);
_608(false);
_5e6(_605);
...
var t = $("<table class=\"datagrid-htable  euig-htable \" border=\"0\" cellspacing=\"0\" cellpadding=\"0\"><tbody></tbody></table>").appendTo(_61f);
...
var _79e=["<table class=\"datagrid-btable euig-btable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<rows.length;i++){
var row=rows[i];
...
if(_8c7.hasClass("fa-file-text-o")){
    _8c7.removeClass("fa-file-text-o").addClass(" fa-folder fa-folder-open");
...
_8df = _8df || {};
$.data(window,'treegrid_w', this);
$(window).resize(function ()
{
    $($.data(this, "treegrid_w").selector).treegrid('resize');
});
return this.each(function(){
...
var _8f9 = ["<table class=\"datagrid-btable  euig-btable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
...
cc.push("<span class=\"tree-indent\"></span>");
cc.push("<span class=\"tree-icon fa fa-file-text-o " + (row.iconCls ? row.iconCls : "") + "\"></span>");
}
}
...
tr.next("tr.treegrid-tr-tree").remove();
var cell=tr.children("td[field=\""+opts.treeField+"\"]").children("div.datagrid-cell");
cell.find(".tree-icon").removeClass("tree-folder").addClass("fa-file-text-o");
