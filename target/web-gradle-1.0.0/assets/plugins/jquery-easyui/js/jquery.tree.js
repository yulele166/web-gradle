...
var _80=$(ul).prev().children("span.fa");
...
_a9.removeClass("fa fa-file-text-o").addClass("fa fa-folder fa-folder-open");
...
var _b4=$(_b3.target);
_b4.find(".tree-icon").removeClass("fa fa-folder").addClass("fa fa-file-text-o");
...
_100(this,q);
   ...
   var parseOptions=function(_b,_c){
        var t=$(_b);
        var _d={};
...
var t=$(_122);
return $.extend({},parseOptions(_122,["url","method",{checkbox:"boolean",cascadeCheck:"boolean",onlyLeafCheck:"boolean"},{animate:"boolean",lines:"boolean",dnd:"boolean"}]));
};
...
var node=$(this);
var item=$.extend({},parseOptions(this,["id","iconCls","state"]),{checked:(node.attr("checked")?true:undefined)});
...
cc.push("<span class=\"tree-indent\"></span>");
cc.push("<span class=\"tree-icon fa fa-file-text-o "+(item.iconCls?item.iconCls:"")+"\"></span>");
_12d=true;
}
}
if(opts.checkbox){
